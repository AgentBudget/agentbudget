...
export const PythonLogo = () => (
  ...
  <img src="https://cdn.simpleicons.org/python" width="13" height="13" alt="Python" style={{ display: "inline" }} />
);

export const GoLogo = () => (
  // eslint-disable-next-line @next/next/no-img-element
  <img src="https://cdn.simpleicons.org/go" width="13" height="13" alt="Go" style={{ display: "inline" }} />
);

export const TSLogo = () => (
  // eslint-disable-next-line @next/next/no-img-element
  <img src="https://cdn.simpleicons.org/typescript" width="13" height="13" alt="TypeScript" style={{ display: "inline" }} />
);
